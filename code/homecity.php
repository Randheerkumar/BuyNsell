                  ...
                  if(req.readyState == 4 && req.status == 200)
                    {
                      ...
                      document.getElementById('overflowTest').innerHTML=req.responseText;

                    }   

               }
             req.open('GET','homecityhead.php','true');
             req.send();
