      ...
      <body>  
                ...
                <table class="table table-bordered">  
                     <tr>  
                          ...
                          <a href="p_listicon3.php?id=<?php echo$cat;?>">sort by price ASC</a>
                ...
                if($sort==0)
                 {
                $q ="SELECT * FROM product WHERE product_id IN(SELECT p_id5 FROM seller_Info INNER JOIN city ON seller_Info.city_name=city.city_name WHERE city.city_id='$city_id')";
                 $_SESSION['sort']=1;  
                 }  
                else
                 {
                    $q ="SELECT * FROM product WHERE product_id IN(SELECT p_id5 FROM seller_Info INNER JOIN city ON seller_Info.city_name=city.city_name WHERE city.city_id='$city_id') ORDER BY price DESC";
